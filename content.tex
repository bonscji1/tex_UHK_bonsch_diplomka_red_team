...
Výborným příkladem je kapitola~\ref{subsec:scenar-1}, zabývající se zjišťováním informací o organizaci, které lze využít k útokům Sociálního inženýrství.
Také kapitola~\ref{subsec:scenar-2}, jež ukazuje získání specifické verze operačního systému a jak tuto informaci může útočník zneužít, ukazuje reálný dopad na skutečnou infrastrukturu.
