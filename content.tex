...
\cite{Enisa_thread_landscape, moje_bakalarka}
%todo adjust
...
Impersonation is when one entity illegitimately assumes the identity of another entity in order to benefit from it.
...
social engineering component. The underlying reason for the criminals' interest in social engineering is obvious. Email is where their potential victims are easiest reachable. And despite awareness raising campaigns and exercises,
...
The leak (or 'disclosure') of the playbook of this group also underlined369 370 371 that
ransomware groups rely heavily on well-established social engineering options372 such as spear phishing and phonecalls as their primary pathway for initial access. Both Europol373 and the FBI374 report that phishing and social
...
instance, a deepfake voice call resulted in a fraudulent bank transfer of nearly $35 million
