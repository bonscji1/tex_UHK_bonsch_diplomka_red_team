...
~\cntcapfigure{ENISA_Ransomware}{\linewidth}{Počet zaznamenaných Ransomware incidentů a velikost ukradených dat ve sledovaném období květen 2021 až červen 2022}{\cite{Enisa_thread_landscape}}\label{fig:ENISA_Ransomware}
...
Adware automaticky zobrazuje reklamy při prohlížení internetu nebo používání reklamou podporovaného softwaru. V kontextu malwaru se adware tajně instaluje na váš počítač nebo mobilní zařízení, sleduje vaši prohlížečovou historii a poté vám poskytuje invazivní reklamy.
...
Keyloggery (klávesové špionážní programy) zaznamenávají všechna stisknutí kláves, která uživatel na svém infikovaném zařízení provede, a následně tuto informaci ukládají do zprávy typicky zakódované. Tento druh škodlivého softwaru, zkráceně nazývaného keylogger, sbírá vše, co uživatel napíše do svého počítače, smartphonu nebo tabletu, včetně textových zpráv, e-mailů, uživatelských jmen a hesel.

Keyloggers record all the keystrokes you make on your infected device and then save the information in a log file that is typically encrypted. Short for “keystroke logging”, this type of spyware collects everything you type into your computer, smartphone, or tablet, including text messages, emails, usernames, passwords.

\paragraph{Infostealer}

Infostealery shromažďují informace z vašich počítačů nebo mobilních systémů. Keyloggery jsou jedním typem infostealeru; další typy mohou dělat mnohem více než zaznamenávat a ukládat informace získané z vašich stisknutí kláves. Mohou například prohledávat váš počítač pro konkrétní informace a sbírat vaši historii prohlížení, dokumenty a relace okamžitých zpráv. Některé verze mohou provádět všechnu svou špinavou práci tajně v jednom úderu, než zmizí z počítačů svých cílů.
...
\paragraph{Red Shell spyware}

Red Shell spyware je typem spywaru, který se nainstaluje během instalace určitých PC her a poté sleduje online aktivity hráčů. Jeho tvůrci uvádějí, že chtějí "využít znalosti k pomoci vývojářům vytvářet lepší hry" a "dělat lepší rozhodnutí o účinnosti svých marketingových kampaní". Protivníci Red Shellu nesouhlasí s tím, že se nainstaluje bez vědomí a souhlasu uživatelů.
...
Cookies mohou být užitečné, například okamžitě vás přihlásí do vašich oblíbených webových stránek a zobrazí vám reklamy na zboží a služby, které jsou relevantní pro vaše zájmy. Nicméně sledovací cookies mohou být považovány za spyware, protože vás sledují online, když prohlížíte internet, sestavují váš prohlížecí historie a zaznamenávají pokusy o přihlášení. S dostatečnými znalostmi a nástroji by mohl black hat hacker použít tyto cookies k opětovnému vytvoření vašich přihlašovacích sezení, takže se ujistěte, že pravidelně mazat sledovací cookies nebo je zcela zakázat.
...
Jeho prvotní kroky jsou však detekovatelné dobrým antivirovým software.
...
%todo omáčka
Linux je Linux, a proto je v rámci kmenové distribuce jednuduchá naistalovat vše, co je potřeba.
Výhoda kli je však předpřipravenost mnoha nástrojů, které nemusí uživatel instalovat zvlášt.

%todo doplŇ omáčku o kali


Menší změna však nastala při 10 výročí této distribuce. %add citation
Vývojáři představili Kali purple.%todo check exact name
...
Prvotní příprava je proto k instalační krok ztížena.
