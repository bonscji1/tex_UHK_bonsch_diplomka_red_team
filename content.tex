...
%~\cntcapfigure{Mitre_Attack_Navigator}{\linewidth}{Mitre ATT\@CK Navigátor}{\cite{mitre_attack_framework}}\label{fig:navigator}
...
Vývojáři představili Kali Purple.
%todo check image and source
%~\cntcapfigure{Kali_Purple_VirtualBox}{\linewidth}{Spuštěná Kali Purple ve virtuálním prostředí \textbf{Zdroj: Vlastní}}{\label{fig:kali_purple}
...
Tento fakt je vidět na ~\ref{fig:caldera_error}.
%todo check zdroj, maybe crop
%~\cntcapfigure{Caldera_error_msg}{\linewidth}{Chyba kompilace Caldera frameworku \textbf{Zdroj: Vlastní}}\label{fig:caldera_error}

Tento problém vyplývá ze starších balíčků, které calder vyžaduje pro svoji funkčnost.
...
Identifikace problémových balíčků je jednoduchá přímo ze zpětné vazby při kompilování, jak je možné vidět na ~\ref{fig:caldera_error}.
...
To je možné vidět na ~\ref{fig:pypi_aiohttp}
%todo check zdroj and picture
%~\cntcapfigure{pypi_aiohttp}{\linewidth}{Nejnovější verze balíčku aiohttp v repozitáři Pypi \textbf{Zdroj: Vlastní}}\label{fig:pypi_aiohttp}
...
%todo check picture and zdroj
%~\cntcapfigure{new_setup}{\linewidth}{Nová podoba souboru requirements.txt \textbf{Zdroj: Vlastní}}\label{fig:new_setup}
...
%todo add piscture of caldera logged in, check how it looks
%~\cntcapfigure{Caldera_running}{\linewidth}{Caldera framework po úvodním přihlášení \textbf{Zdroj: Vlastní}}\label{fig:Caldera_running}



%todo check if we even use this
\paragraph{Recon-ng}
Poslední nástrojem, který je nutné připravit je \textit{Recon-ng}.
