...
Je možné od něj očekávat pozorné zkoumání cíle a vytrvalost, když si cíl zvolí.
Tiše hledá slabiny a proniká do střežených systémů bez povšimnutí.
Naštěstí pro obránce je těchto útočníků málo.
...
Nebezpečnost této skupiny v posledních letech vzrostla také díky propagaci \firstac{MaaS}\cite{MaaS_ATaT} a \firstac{RaaS}\cite{RaaS_microsoft}.
...
Základní situací je Celkový pokus o kompromitaci obrany.
Je to snaha \textit{red teamu} napadnout celou infrastrukturu organizace a pokusit se kompromitovat co možná největší možnou část.
Tato strategie je vhodná pro celkové testování infrastruktury.
Lze takto testovat správnou fragmentaci infrastruktury a resistivity jednotlivých fragmentů.
Z velkého a otevřeného rozhasu však vyplívá jen omezená možnost testování do hloubky a zaměření se na specifické části infrastruktury.
...
Specifické pokusy o kompromitaci jsou ty, při kterých je určitá část útočné plochy prioritizována pro hodnocení a zbytek organizace je mimo dosah.

\paragraph{Předpokládaný kompromis}

Předpokládaný kompromis je angažování red teamu, kdy hodnocení začíná s přístupem, který je poskytnut hodnotitelům a je založen na předpokladu úspěšné infiltrace aktérem.
...
Právě z těchto důvodů jsou v následujícím textu vysvětleny.\cite{securityInteligence_pen_test_red_team_purple_team}
