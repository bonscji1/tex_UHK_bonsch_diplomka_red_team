...
Tato skupina se v posledních letech rozrostla také díky propagaci \firstac{RaaS} a \firstac{MaaS}.
Existence nástrojů, které dovolují provézt úspěšný útok za pomocí znalostí zkušenějšího útočníka však znamená, že ani nezkušené útočníky není možné podceňovat.
