...
Nelze říci, zda je jeden scénář lepší nežli jiné, naopak se doplňují a každý slouží pro určitou situaci.

\paragraph{Celkový pokus o kompromitaci}
% todo


Celkový pokus o kompromitaci zahrnuje snahu red teamu napadnout co největší část útočné plochy cílové organizace s cílem kompromitovat co nejvíce (obrázek 1-1).
...
Každá tato třída angažování red teamu přináší své vlastní výzvy a složitosti a podtřídy, přičemž každá je vhodná pro různé testovací scénáře.
