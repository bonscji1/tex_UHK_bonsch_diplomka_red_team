...
--Censys
- po zadání doménového jména nebo IP adresy serveru načte informace o službách a jejich portech
- není tak detailní jako nmap, ale je online a bez nutnosti instalace dalších nástrojů
-nalezeny 2 záznamy, informace jsou:
...
--Na webovém serveru je spuštěna samotná internetová stránka, specificky porty 80 a 443.
--protokolu na výměnu bezpečnostních klíčů IKE na portu 500
--spuštěná webová služba na portu 10443
--Při zadání adresy sportem do prohlížeče je uživatel přesměrován na přihlášení do systému od společnosti Sophos, která se zabývá vytvářením bezpečnostního softwaru a hardwaru.

--10443 přes HTTP protokol přihlašovací formulář do služby společnosti Fortinet
--Uživatel má možnost zadat přihlašovací jméno a heslo, popřípadě spustit aplikaci FortiClient.
--možný access point pro supply-chain útok

\nlparagraph{Nmap}
Nástroj pro skenování portů nmap je dlouhodobě využívaný nástroj mnoha útočníků a tak je dobré vědět, co s ním jde o daném cíli zjistit.




%todo del redundant
Jedná se o nástroj umožňující aktivní skenování vsíti.
Uživatel musí zadat potřebné vlastnosti prováděného skenu a definovat svůj cíl.
Jako cíl je možné zvolit doménu, adresu či skupinu adres. (informace co jsme již nalezli)
Zároveň je možné definovat skenování portů, kdy se program pokusí získat informace o aktivních portech, protokolech, spuštěných službách a jejich verzích.
Následně bylo nastaveno, aby program po ukončení své funkce vyexportoval výsledek do textového souboru.

--vysledek potvrdil již zjištěné informace ale poskytl i nové webového serveru, na které je spuštěn internetový portál.
--pokusil zjistit verze běžících služeb na daných portech. Zajímavou informací je verze webového serveru, na které je spuštěn internetový portál. Jedná se o dnes již starší verzi serveru Apache 2.4.29 vydané vdruhé polovině roku 2017.
-- Jedná se o dnes již starší verzi serveru Apache 2.4.29 vydané vdruhé polovině roku 2017 <- zastaralé
--Na tuto verzi je možné na internetu nalézt několik chyb a zranitelností. Dále byl nalezen port 5060 sprotokolem SIP a port 8443 se službou OpenVPN.
