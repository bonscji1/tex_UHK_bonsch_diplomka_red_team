...
kontrola citací, jestli jsou správně
...
Jsou kladeny stále větší nároky na bezpečnost, ani to se však nezdá být dostatečné.
Objevují se nové hrozby, ale i ty stávající se neustále vyvíjí, což vede k nutnosti vytváření pokročilejších metod obrany.
...
Internet navíc přinesl dostupnost informací nejen běžným občanům, ale i útočníkům, kteří proto nemají problém vytvářet propracované útoky ani získat nové postupy od jiných útočníků.
...
Pokrok digitalizace sice usnaďnuje mnohým obyvatelům život, je však potřebné myslet i na riziku, kterém jím hrozí primárně v podobě úniku osobních informací.
Je nutné vytvářet, dodržovat a obnovovat mnoho předpisů zajištující holistickou obranu všech subjektů.
...
Proto bylo vytvořeno testovací prostředí, testované prostředí napodobující reálnou infrastruktury a scénáře možných útoky, jenž jsou s pomocí těchto prostředí testovány.
Výsledkem jsou cenná data, ukazující silné i slabé stránky testované infrastruktury, a postupy, jak sestavit a upravit testovací prostředí pro potřeby testování v praxi.
