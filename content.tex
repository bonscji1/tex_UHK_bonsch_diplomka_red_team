...
~\cntcapfigure{pypi_aiohttp}{\linewidth}{Nejnovější verze balíčku aiohttp v repozitáži Pypi \textbf{Zdroj: Vlastní}}\label{fig:pypi_aiohttp}
...
Vybrané moduly jsou nainstalovány příkazem \textbf{marketplace install \textit{jmeno_modulu}}.
