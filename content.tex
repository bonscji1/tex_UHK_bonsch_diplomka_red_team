...
Také ovládání je zvláštní a s existencí specializovaných nástrojů jako je \textit{nmap} bylo po otestování od použití tohoto nástroje v labech odstoupeno.
...
\section{Závěry a doporučení}\label{sec:zavery-a-doporuceni2}
