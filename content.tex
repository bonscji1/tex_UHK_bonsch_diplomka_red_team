...
Rootkity umožňují zločincům infiltrovat počítače a mobilní zařízení a získat přístup na velmi hluboké úrovni. K tomu mohou využít bezpečnostní zranitelnosti, použít trojského koně nebo se přihlásit na stroj jako administrátor. Rootkity jsou obvykle obtížné nebo nemožné detekovat, ale mohou být předcházeny silným antivirovým softwarem.
