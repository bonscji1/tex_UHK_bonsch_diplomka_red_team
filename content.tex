...
Pro kompletnost je při zkoumání bezpečnostního nutné uvažovat i o utočnících.
Ty je možné zařadit do několika prominentních skupin.
Jsou jimi:
\begin{itemize}
	\item Recreational attacker,
	\item Script kiddies,
	\item Hacktivist
	\item Hacker-for-hire
	\item Cyber criminals
	\item State-sponsored actors
	\item Insider
