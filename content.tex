...
\nlparagrap{Adversary pro scénář 2}
...
\nlparagraph{lab02v2}
%todo
specifické zaměření na privilegia a discovery
...
%todo del
jak jsme to to testovali, tady krok po kroku od udělání agenta, adversary, operace až po výsledky a output

\subsubsection{Scénář 3 - discovery a worm}
